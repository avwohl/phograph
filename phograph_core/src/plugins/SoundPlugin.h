 ...
 *
 * Provides a ring buffer fed by the engine thread and drained by the
 * audio system callback.
 *
 * Derived from iospharo SoundPlugin (source-level sharing).
 */

#ifndef PHO_SOUND_PLUGIN_H
#define PHO_SOUND_PLUGIN_H
...
// Copy samples from buffer into the ring buffer.
